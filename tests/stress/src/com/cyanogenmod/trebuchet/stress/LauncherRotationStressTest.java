...
package com.eclipse.lunar.stress;


import com.eclipse.lunar.Launcher;
...
/**
 * Run rotation stress test using lunar for 50 iterations.
 */
public class LauncherRotationStressTest extends ActivityInstrumentationTestCase2<Launcher> {
    ...
    private static final String LOG_TAG = "lunarRotationStressTest";
